...
%global oname postgres-xl
%global	pgxlbaseinstdir	/usr/postgres-xl-%{majorversion}
...
Source0:   	postgres-xl-%{version}r%{release}.tar.gz	
Source4:	Makefile.regress
Source5:	pg_config.h
Source6:	README.rpm-dist
Source7:	ecpg_config.h
Source9:	pgxl-9.5-libs.conf
...
Buildrequires:	perl glibc-devel bison flex >= 2.5.31 vim-minimal
...
%prep
%setup -q -n postgres-xl-%{version}r%{release}
%patch1 -p1
%patch3 -p1
...
mv doc/src/sgml/man1 doc/src/sgml/man3 doc/src/sgml/man7  %{buildroot}%{pgxlbaseinstdir}/share/man/
...
%{pgxlbaseinstdir}/share/man/man1/pg_test_fsync.1
%{pgxlbaseinstdir}/share/man/man1/pg_test_timing.1
